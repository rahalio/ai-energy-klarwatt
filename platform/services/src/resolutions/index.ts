/**
 * Resolutions Services - Application Layer Export
 *
...
/**
 * Resolutions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for resolutions domain.
 */
