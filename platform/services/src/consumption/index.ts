/**
 * Consumption Services - Application Layer Export
 *
...
/**
 * Consumption Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for consumption domain.
 */
