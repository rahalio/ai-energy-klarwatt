...
export type RecogniseComplaintRequestInput = NonNullable<operations["recogniseComplaint"]["requestBody"]>["content"]["application/json"];
...
export type RecogniseComplaintResponse = operations["recogniseComplaint"]["responses"]["201"]["content"]["application/json"];
